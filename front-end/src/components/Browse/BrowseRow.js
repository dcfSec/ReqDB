 ...
 * 
 * @param {object} param0 Props for this component: index, extraHeaders, extraHeaderTypes, row, search, tags, tagFiltered, topicFiltered, markRowCallback, markRowChecked
