...
import { faSun, faMoon, faDatabase, faLink, faComment, faPaperPlane, faEraser, faPen, faCheck, faArrowsRotate, faArrowRight, faCodeCompare } from '@fortawesome/free-solid-svg-icons'
import { faCircleQuestion, faEye, faEyeSlash } from '@fortawesome/free-regular-svg-icons';


library.add(faGithub, faSun, faMoon, faDatabase, faEyeSlash, faEye, faLink, faComment, faPaperPlane, faEraser, faPen, faCheck, faArrowsRotate, faArrowRight, faCircleQuestion, faCodeCompare)
